...
create table like (like_id CHAR(16) FOR BIT DATA not null, created timestamp not null, sketch_id CHAR(16) FOR BIT DATA not null, user_profile_id CHAR(16) FOR BIT DATA not null, primary key (like_id))
create table sketch (sketch_id CHAR(16) FOR BIT DATA not null, created timestamp not null, name varchar(255) not null, sketch_description varchar(255), updated timestamp not null, user_profile CHAR(16) FOR BIT DATA, primary key (sketch_id))
create table user_profile (user_profile_id CHAR(16) FOR BIT DATA not null, auth_id varchar(255) not null, bio varchar(255), created timestamp not null, updated timestamp not null, username varchar(255) not null, primary key (user_profile_id))
alter table sketch add constraint UK_ombsd58sggb1oscqmcyq927p9 unique (name)
alter table like add constraint FKc04dbur55q7b198g1vimvoil6 foreign key (sketch_id) references sketch
alter table like add constraint FKj6cijr407hmrl2fdcdsbfikdx foreign key (user_profile_id) references user_profile
alter table sketch add constraint FK6qj29jl2of0ovulsq4a5brckq foreign key (user_profile) references user_profile
create table likes (like_id CHAR(16) FOR BIT DATA not null, created timestamp not null, sketch_id CHAR(16) FOR BIT DATA not null, user_profile_id CHAR(16) FOR BIT DATA not null, primary key (like_id))
create table sketch (sketch_id CHAR(16) FOR BIT DATA not null, created timestamp not null, name varchar(255) not null, sketch_description varchar(255), updated timestamp not null, user_profile CHAR(16) FOR BIT DATA, primary key (sketch_id))
create table user_profile (user_profile_id CHAR(16) FOR BIT DATA not null, auth_id varchar(255) not null, bio varchar(255), created timestamp not null, updated timestamp not null, username varchar(255) not null, primary key (user_profile_id))
alter table sketch add constraint UK_ombsd58sggb1oscqmcyq927p9 unique (name)
alter table likes add constraint FK3ekjicuy3uixba2ouk8vm077d foreign key (sketch_id) references sketch
alter table likes add constraint FKfeolyujkxx6x7d2o10pmbcj4p foreign key (user_profile_id) references user_profile
alter table sketch add constraint FK6qj29jl2of0ovulsq4a5brckq foreign key (user_profile) references user_profile
create table likes (like_id CHAR(16) FOR BIT DATA not null, created timestamp not null, sketch_id CHAR(16) FOR BIT DATA not null, user_profile_id CHAR(16) FOR BIT DATA not null, primary key (like_id))
create table sketch (sketch_id CHAR(16) FOR BIT DATA not null, created timestamp not null, name varchar(255) not null, sketch_description varchar(255), updated timestamp not null, user_profile CHAR(16) FOR BIT DATA, primary key (sketch_id))
create table user_profile (user_profile_id CHAR(16) FOR BIT DATA not null, auth_id varchar(255) not null, bio varchar(255), created timestamp not null, updated timestamp not null, username varchar(255) not null, primary key (user_profile_id))
...
alter table sketch add constraint FK6qj29jl2of0ovulsq4a5brckq foreign key (user_profile) references user_profile
create table likes (like_id CHAR(16) FOR BIT DATA not null, created timestamp not null, sketch_id CHAR(16) FOR BIT DATA not null, user_profile_id CHAR(16) FOR BIT DATA not null, primary key (like_id))
create table sketch (sketch_id CHAR(16) FOR BIT DATA not null, code varchar(4000), created timestamp not null, name varchar(255) not null, sketch_description varchar(255), updated timestamp not null, user_profile CHAR(16) FOR BIT DATA, primary key (sketch_id))
create table user_profile (user_profile_id CHAR(16) FOR BIT DATA not null, auth_id varchar(255) not null, bio varchar(255), created timestamp not null, updated timestamp not null, username varchar(255) not null, primary key (user_profile_id))
alter table sketch add constraint UK_ombsd58sggb1oscqmcyq927p9 unique (name)
alter table likes add constraint FK3ekjicuy3uixba2ouk8vm077d foreign key (sketch_id) references sketch
alter table likes add constraint FKfeolyujkxx6x7d2o10pmbcj4p foreign key (user_profile_id) references user_profile
